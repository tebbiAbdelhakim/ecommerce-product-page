...
next.addEventListener('click', () => {
    ...
    if (bg == 'url("https://ecommerce-product-page-git-main-tebbiabdelhakim.vercel.app/images/image-product-1.jpg")') {
        ...
        productImg.style.backgroundImage = 'url("https://ecommerce-product-page-git-main-tebbiabdelhakim.vercel.app/images/image-product-3.jpg")';
...
prev.addEventListener('click', () => {
    const cssObj = window.getComputedStyle(productImg, null);
    let bg = cssObj.getPropertyValue("background-image");
    if (bg == 'url("https://ecommerce-product-page-git-main-tebbiabdelhakim.vercel.app/images/image-product-4.jpg")') {
        productImg.style.backgroundImage = 'url("https://ecommerce-product-page-git-main-tebbiabdelhakim.vercel.app/images/image-product-3.jpg")';
    } else if (bg == 'url("https://ecommerce-product-page-git-main-tebbiabdelhakim.vercel.app/images/image-product-3.jpg")') {
        productImg.style.backgroundImage = 'url("https://ecommerce-product-page-git-main-tebbiabdelhakim.vercel.app/images/image-product-2.jpg")';
    } else if (bg == 'url("https://ecommerce-product-page-git-main-tebbiabdelhakim.vercel.app/images/image-product-2.jpg")') {
        console.log("hohoh");
        productImg.style.backgroundImage = 'url("https://ecommerce-product-page-git-main-tebbiabdelhakim.vercel.app/images/image-product-1.jpg")';
    }
});
...
//https://ecommerce-product-page-git-main-tebbiabdelhakim.vercel.app/
...
nex.addEventListener('click', () => {
    ...
    let bg = cssObj.getPropertyValue("background-image");
    if (bg == 'url("https://ecommerce-product-page-git-main-tebbiabdelhakim.vercel.app/images/image-product-1.jpg")') {
        popupImg.style.backgroundImage = 'url("https://ecommerce-product-page-git-main-tebbiabdelhakim.vercel.app/images/image-product-2.jpg")';
    } else if (bg == 'url("https://ecommerce-product-page-git-main-tebbiabdelhakim.vercel.app/images/image-product-2.jpg")') {
        popupImg.style.backgroundImage = 'url("https://ecommerce-product-page-git-main-tebbiabdelhakim.vercel.app/images/image-product-3.jpg")';
    } else if (bg == 'url("https://ecommerce-product-page-git-main-tebbiabdelhakim.vercel.app/images/image-product-3.jpg")') {
        popupImg.style.backgroundImage = 'url("https://ecommerce-product-page-git-main-tebbiabdelhakim.vercel.app/images/image-product-4.jpg")';
    }
    console.log(bg);
});
...
pre.addEventListener('click', () => {
    ...
    if (bg == 'url("https://ecommerce-product-page-git-main-tebbiabdelhakim.vercel.app/images/image-product-4.jpg")') {
        ...
        console.log("hohoh");
        popupImg.style.backgroundImage = 'url("https://ecommerce-product-page-git-main-tebbiabdelhakim.vercel.app/images/image-product-1.jpg")';
    }
});
